      ...
      <div className="flex flex-col gap-4 px-6">
        ...
        <div className="hairline-t flex items-center gap-3 pt-4">
          ...
          <span className="flex min-w-0 flex-1 flex-col gap-px">
            <span className="truncate text-[12.5px]">{CURRENT_USER.name}</span>
            <span className="t-mono-2xs text-muted">{CURRENT_USER.role}</span>
          </span>
          <button
            type="button"
            onClick={signOut}
            className="t-mono-2xs text-muted wc-hoverable cursor-pointer"
          >
            Exit
          </button>
        </div>
